...
import dnldd.backpack.BarcodeTrackerFactory;
import dnldd.backpack.CameraSourcePreview;
import dnldd.backpack.GraphicOverlay;
...
public class BarcodeActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        uiHelper = new SystemUiHelper( this, SystemUiHelper.LEVEL_HIDE_STATUS_BAR, 0);
        uiHelper.hide();
    }
    ...
    public void setupBarcodeActivity(int layoutResID){
